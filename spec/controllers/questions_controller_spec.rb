...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "PUT update" do
     it "updates question with expected attributes" do
       ...
       put :update, params: {id: my_question.id, title: new_title, body: new_body, resolved: false }, as: :json
     ...
     it "redirects to the updated question" do
       ...
       put :update, params: {id: my_question.id, title: new_title, body: new_body, resolved: true }, as: :json
